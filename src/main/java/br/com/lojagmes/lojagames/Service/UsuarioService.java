package br.com.lojagmes.lojagames.Service;
...
import br.com.lojagmes.lojagames.Model.UsuarioLogin;
import br.com.lojagmes.lojagames.Model.UsuarioModel;
import br.com.lojagmes.lojagames.Repository.UsuarioRepository;
	...
	public Optional<UsuarioLogin> autenticarUsuario(Optional<UsuarioLogin> usuarioLogin) {
		...
		if (buscaUsuario.isPresent()) {
			...
			if (compararSenhas(usuarioLogin.get().getSenha(), buscaUsuario.get().getSenha())) {
				...
				usuarioLogin.get().setId(buscaUsuario.get().getIdUsuario());
